...
while True:
    ...
    print("    Missions")
    for x in range(0, 3):
        device.shell("input tap 640 684")  # Update Coordinates
        time.sleep(0.5)
    ...
    device.shell("input tap 535 585")  # Select Bounty Button
    time.sleep(1)
    ...
    for x in range(74, 615, 130):  # Unselect Heroes
    ...
    for z in range(0, 6):
        ...
        print("    Go Anyway")
        device.shell("input tap 651 557")
        time.sleep(1)
