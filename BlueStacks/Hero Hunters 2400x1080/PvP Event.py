...
while True:
    ...
    device.shell(f"input tap 1075 681")  # Play Button
    time.sleep(200)
    print("Clicked Next button")
    device.shell(f"input tap 1075 681")  # Next Button
    time.sleep(2)
    print("Clicked Next button")
    device.shell(f"input tap 1075 681")  # Play Button
    time.sleep(2)
    print("Clicked Open Crate button")
    device.shell(f"input tap 630 620")  # Open Crate Button
    time.sleep(5)
    device.shell(f"input tap 630 620")  # Open Crate Button
    time.sleep(2)
    device.shell(f"input tap 630 620")  # Open Crate Button
    ...
    device.shell(f"input tap 862 407")
    time.sleep(2)
