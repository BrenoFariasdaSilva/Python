            ...
            writer.writerow(
                {
                    ...
                    "Commit Hash": commit[1],
                    "Commit Date": commit[2],
...
def process_all_splits(repo_url, repo_name):
    ...
    print(
        f"{BackgroundColors.CYAN}SPLIT_ALL{BackgroundColors.GREEN} is enabled. Fetching repository tags...{Style.RESET_ALL}"
    )
    ...
    print(
        f"{BackgroundColors.GREEN}Found {BackgroundColors.CYAN}{len(tags)}{BackgroundColors.GREEN} tags. Generating split CSVs...{Style.RESET_ALL}\n"
    )
    ...
    for index, (from_tag, to_tag) in enumerate(segments, start=1):  # Iterate over each segment
        ...
        print(
            f"{BackgroundColors.GREEN}Processing split {BackgroundColors.CYAN}{index}{BackgroundColors.GREEN}: {BackgroundColors.CYAN}{label_from}{BackgroundColors.GREEN} to {BackgroundColors.CYAN}{label_to}{Style.RESET_ALL}"
        )

        commits_tuple_list = get_commits_information(
            repo_url, from_tag, to_tag
        )  # Get the commits information for the segment
...
def main():
    ...
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Commits List Between Tags Generator{BackgroundColors.GREEN}!{Style.RESET_ALL}"
    )
    print(
        f"{BackgroundColors.GREEN}If you don't have the repository tags, you can generate them using the {BackgroundColors.CYAN}Repository Tags Lister{BackgroundColors.GREEN} program.{Style.RESET_ALL}\n"
    )
    ...
    ):  # If both tags are missing and SPLIT_ALL is enabled
    ...
    print(
        f"{BackgroundColors.GREEN}Generating commit CSV from {BackgroundColors.CYAN}{from_tag}{BackgroundColors.GREEN} to {BackgroundColors.CYAN}{to_tag}{BackgroundColors.GREEN} for the repository {BackgroundColors.CYAN}{repo_name}{BackgroundColors.GREEN}...{Style.RESET_ALL}"
    )
