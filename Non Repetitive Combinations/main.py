...
def main():
    ...
    print(
        f"{BackgroundColors.GREEN}Completed the generation of {BackgroundColors.CYAN}{len(non_repetitive_combinations)}{BackgroundColors.GREEN} combinations!{Style.RESET_ALL}"
    )
