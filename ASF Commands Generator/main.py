...
def sort_games(input_file, output_file):
        ...
        for line in file:  # For each line in the file
            ...
            if len(parts) == 2:  # If the length of the parts is 2
                ...
                if game_name in games:  # If the game is in the games dictionary
                    print(
                        f"{BackgroundColors.RED}Duplicate game {BackgroundColors.CYAN}{game_name}{BackgroundColors.RED} found!{Style.RESET_ALL}"
                    )  # Output the duplicate game message
    ...
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Games sorted and written to {BackgroundColors.CYAN}{output_file}{Style.RESET_ALL}"
    )
...
def generate_asf_command(appids, output_file):
    ...
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}ASF commands generated and written to {BackgroundColors.CYAN}{output_file}{Style.RESET_ALL}"
    )
...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}ASF Command Generator{BackgroundColors.GREEN} program!{Style.RESET_ALL}\n"
