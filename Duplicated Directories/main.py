...
def search_duplicates(directories_list):
    ...
    while current_index < list_size:
        if directories_list[current_index] == directories_list[current_index + 1] and current_index + 1 < list_size:
            print(
                f"{BackgroundColors.GREEN}Duplicate: {BackgroundColors.CYAN}{directories_list[current_index]}{Style.RESET_ALL}"
            )
...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Duplicated Directories Finder{BackgroundColors.GREEN}!{Style.RESET_ALL}"
    ...
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Execution finished.{Style.RESET_ALL}"
