...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the Video Converter!{Style.RESET_ALL}",
        end="\n\n",
    ...
    if not verify_ffmpeg():
        print(
            f"{BackgroundColors.YELLOW}Error: {BackgroundColors.CYAN}ffmpeg{BackgroundColors.YELLOW} is not installed. Please install ffmpeg and try again.{Style.RESET_ALL}"
        )
        return
    ...
    if not verify_input_path_exists(input_path):
        print(
            f"{BackgroundColors.YELLOW}Error: {BackgroundColors.CYAN}{input_path}{BackgroundColors.YELLOW} does not exist. Please check the path and try again.{Style.RESET_ALL}"
        )
        return
