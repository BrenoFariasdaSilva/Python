...
def main():
    ...
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Movie Year Verifier Python{BackgroundColors.GREEN} program!{Style.RESET_ALL}",
        end="\n\n",
