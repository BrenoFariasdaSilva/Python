...
def calculate_initial_points(race1_positions):
    initial_points = {"yellow": 0, "blue": 0, "red": 0, "purple": 0}
...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}Welcome to the {BackgroundColors.CYAN}Tyccon Racers Results Calculation Program{BackgroundColors.GREEN}!{Style.RESET_ALL}\n"
    )
    ...
    winning_cases = evaluate_winning_cases(
        permutations_positions, initial_points, race1_positions, race2_positions, user_team
    )
