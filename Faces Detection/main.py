...
def print_detected_faces(detected_faces):
    ...
    for image in detected_faces:
        print(
            f"{BackgroundColors.GREEN}Faces Detected in {BackgroundColors.CYAN}{image}{BackgroundColors.GREEN}: {BackgroundColors.CYAN}{detected_faces[image]}{Style.RESET_ALL}"
...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.GREEN}{BackgroundColors.BOLD}Welcome to {BackgroundColors.UNDERLINE}Faces Cut Algorithm{Style.RESET_ALL}"
