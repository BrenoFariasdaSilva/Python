...
def file_remover(full_path):
    ...
    if file_extension in EXECUTABLE_EXTENSIONS:
        print(
            f"{BackgroundColors.CYAN}Deleted {BackgroundColors.CYAN}{full_path}{Style.RESET_ALL}"
        )  # Print the file path
...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Executable Code Deleter{BackgroundColors.GREEN}!{Style.RESET_ALL}"
