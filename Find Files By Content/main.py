...
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Find Files By Content{BackgroundColors.GREEN} program!{Style.RESET_ALL}"
    )
    ...
    if number_of_files > 0:  # If there are files that contain the specified strings
        print(
            f"{BackgroundColors.GREEN}Found the following {BackgroundColors.BOLD}{BackgroundColors.CYAN}{number_of_files}{Style.RESET_ALL}{BackgroundColors.GREEN} files: {Style.RESET_ALL}"
        )
