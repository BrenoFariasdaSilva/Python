...
def sort_csv(input_file, sorting_column):
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Sorting CSV file {BackgroundColors.CYAN}{input_file}{BackgroundColors.GREEN} by column {BackgroundColors.CYAN}{sorting_column}{BackgroundColors.GREEN}...{Style.RESET_ALL}"
    )  # Output the sorting message
...
def write_csv(output_file, header, sorted_lines):
    ...
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}CSV file {BackgroundColors.CYAN}{output_file}{BackgroundColors.GREEN} written.{Style.RESET_ALL}"
    )  # Output the writing message


# This is the Main function
def main():
    print(
        f"{BackgroundColors.CLEAR_TERMINAL}{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the CSV Sorter by Specific Column program!{Style.RESET_ALL}",
        end="\n\n",
